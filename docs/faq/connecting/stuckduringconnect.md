---
title: "Stuck on “Locating server” or at downloading resource packs"
outline: deep
---
...
Axolotl-PM is currently known to have problems when using large resource packs on the server.
