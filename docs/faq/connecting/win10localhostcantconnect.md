---
title: "Minecraft can’t connect to a server on the same computer on Windows"
outline: deep
---

::: info Note
This is not a case anymore since Minecraft for Windows migrated from UWP to GDK
:::
