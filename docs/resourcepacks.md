---
title: "Resource Packs & Behaviour Packs"
outline: deep
---

# Resource Packs & Behaviour Packs

Axolotl-PM has some support for resource packs.
...
::: warning Warning
Resource packs which **depend on behaviour packs** may not work correctly. While Axolotl-PM will not prevent you loading such packs, it makes no attempt to validate dependencies and your game may experience errors or crashes when attempting to use them.
:::
