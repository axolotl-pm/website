...
Axolotl-PM's behaviour is controlled by several configuration files. You can edit them to change the behaviour of your server.
...
[Read more about installing resource packs.](/docs/resourcepacks)
