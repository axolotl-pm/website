---
title: "Development plugin types"
outline: deep
---
...
**Note:** this plugin format is **not** enabled by default. The [DevTools](https://github.com/pmmp/DevTools/releases) plugin is required to load this type of plugin.
...
1. If you don't have the [DevTools](https://github.com/pmmp/DevTools/releases) plugin, [download its phar file](https://github.com/pmmp/DevTools/releases/latest) and put it in your `plugins` folder.
...
Check out the [example on GitHub](https://github.com/axolotl-pm/PocketMine-MP/blob/stable/examples/plugins/ExampleScriptPlugin.php).
