...
This plugin format consists of a single [PHAR](https://www.php.net/manual/en/intro.phar.php) file which bundles all of the files necessary to make the plugin work.
