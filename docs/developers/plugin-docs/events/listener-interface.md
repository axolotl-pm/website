---
title: "Using the pocketmine\\event\\Listener interface"
outline: deep
---
...
When you call `registerEvents()`, Axolotl-PM does some complicated [reflection](https://www.php.net/manual/en/book.reflection.php) magic to examine the functions declared in the given listener object.
