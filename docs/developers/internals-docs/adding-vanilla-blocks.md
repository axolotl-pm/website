---
title: "How to add a new vanilla block to Axolotl-PM"
outline: deep
---

# How to add a new *vanilla* block to Axolotl-PM
...
strings. This allows Axolotl-PM to implement blocks however we like
