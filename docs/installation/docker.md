...
```sh
docker run -it -p 19132:19132/udp -v $PWD/data:/data -v $PWD/plugins:/plugins ghcr.io/axolotl-pm/pocketmine-mp:5.49.1
```

This command will run version `5.49.1` of Axolotl-PM instead of the latest version.
...
dc20edd3dd62   ghcr.io/axolotl-pm/pocketmine-mp:5.49.1   "start-pocketmine"       7 seconds ago   Up 6 seconds   19132/tcp, 0.0.0.0:19132-19133->19132-19133/udp, :::19132-19133->19132-19133/udp   brave_dijkstra
```
